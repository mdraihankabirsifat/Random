...
Redistribute two equal powers-of-two cake piles by transferring half a pile.
Output a minimum operation sequence that gives the first person exactly x cakes.
*/
